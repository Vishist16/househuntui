    ...
    return (
        <div className="gig">
            {isLoading ? "Loading" : error ? "Something went wrong!" : <div className="container">
                <div className="left">
                    <span className="breadCrumbs">HouseHuntHQ {">"} Availaible Listings {">"} Listing</span>
                    <h1>{data.title}</h1>
                        ...
                        <div className="box">
                            <div className="items">
                                ...
                                <div className="item">
                                    ...
                                    <span className="desc">April 2023</span>
                                </div>
                                <div className="item">
                                ...
                                <div className="item">
                                    ...
                                    <span className="desc">Few hours ago..</span>
                                </div>
                                <div className="item">
                ...
                <div className="right">
                    ...
                    <div className="details">
                        <div className="item">
                            ...
                            <span>{data.deliveryTime} hours open</span>
                        </div>
                        <div className="item">
                            <img src="/img/recycle.png" alt="" />
                            <span>Deposit Amount Rs. {data.revisionNumber}</span>
                        </div>
                    </div>
